...
#define F1AP_ProtocolIE_ID_id_SL_ConfigDedicatedEUTRA_Info	((F1AP_ProtocolIE_ID_t)342)
...
#define F1AP_ProtocolIE_ID_id_Extended_GNB_CU_Name	((F1AP_ProtocolIE_ID_t)426)
#define F1AP_ProtocolIE_ID_id_Extended_GNB_DU_Name	((F1AP_ProtocolIE_ID_t)427)
#define F1AP_ProtocolIE_ID_id_F1CTransferPath	((F1AP_ProtocolIE_ID_t)428)
#define F1AP_ProtocolIE_ID_id_SFN_Offset	((F1AP_ProtocolIE_ID_t)429)
#define F1AP_ProtocolIE_ID_id_TransmissionStopIndicator	((F1AP_ProtocolIE_ID_t)430)
#define F1AP_ProtocolIE_ID_id_SrsFrequency	((F1AP_ProtocolIE_ID_t)431)
#define F1AP_ProtocolIE_ID_id_SCGIndicator	((F1AP_ProtocolIE_ID_t)432)
#define F1AP_ProtocolIE_ID_id_EstimatedArrivalProbability	((F1AP_ProtocolIE_ID_t)433)
#define F1AP_ProtocolIE_ID_id_TRPType	((F1AP_ProtocolIE_ID_t)434)
#define F1AP_ProtocolIE_ID_id_SRSSpatialRelationPerSRSResource	((F1AP_ProtocolIE_ID_t)435)
#define F1AP_ProtocolIE_ID_id_PDCPTerminatingNodeDLTNLAddrInfo	((F1AP_ProtocolIE_ID_t)436)
#define F1AP_ProtocolIE_ID_id_ENBDLTNLAddress	((F1AP_ProtocolIE_ID_t)437)
#define F1AP_ProtocolIE_ID_id_PosMeasurementPeriodicityExtended	((F1AP_ProtocolIE_ID_t)438)
#define F1AP_ProtocolIE_ID_id_PRS_Resource_ID	((F1AP_ProtocolIE_ID_t)439)
#define F1AP_ProtocolIE_ID_id_LocationMeasurementInformation	((F1AP_ProtocolIE_ID_t)440)
#define F1AP_ProtocolIE_ID_id_InterFrequencyConfig_NoGap	((F1AP_ProtocolIE_ID_t)651)
#define F1AP_ProtocolIE_ID_id_L571Info	((F1AP_ProtocolIE_ID_t)659)
#define F1AP_ProtocolIE_ID_id_L1151Info	((F1AP_ProtocolIE_ID_t)660)
#define F1AP_ProtocolIE_ID_id_NeedForGapsInfoNR	((F1AP_ProtocolIE_ID_t)665)
#define F1AP_ProtocolIE_ID_id_PosMeasurementPeriodicityNR_AoA	((F1AP_ProtocolIE_ID_t)672)
#define F1AP_ProtocolIE_ID_id_ConfigRestrictInfoDAPS	((F1AP_ProtocolIE_ID_t)678)
#define F1AP_ProtocolIE_ID_id_PosSItypeList	((F1AP_ProtocolIE_ID_t)682)
#define F1AP_ProtocolIE_ID_id_DAPS_HO_Status	((F1AP_ProtocolIE_ID_t)683)
#define F1AP_ProtocolIE_ID_id_UplinkTxDirectCurrentTwoCarrierListInfo	((F1AP_ProtocolIE_ID_t)684)
#define F1AP_ProtocolIE_ID_id_ServCellInfoList	((F1AP_ProtocolIE_ID_t)707)
#define F1AP_ProtocolIE_ID_id_Transmission_Bandwidth_asymmetric	((F1AP_ProtocolIE_ID_t)852)
