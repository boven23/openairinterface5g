...
typedef enum F1AP_UnsuccessfulOutcome__value_PR {
	...
	F1AP_UnsuccessfulOutcome__value_PR_BAPMappingConfigurationFailure,
	F1AP_UnsuccessfulOutcome__value_PR_GNBDUResourceConfigurationFailure,
	F1AP_UnsuccessfulOutcome__value_PR_IABTNLAddressFailure,
...
typedef struct F1AP_UnsuccessfulOutcome {
	...
	struct F1AP_UnsuccessfulOutcome__value {
		...
		union F1AP_UnsuccessfulOutcome__F1AP_value_u {
			...
			F1AP_BAPMappingConfigurationFailure_t	 BAPMappingConfigurationFailure;
			F1AP_GNBDUResourceConfigurationFailure_t	 GNBDUResourceConfigurationFailure;
			F1AP_IABTNLAddressFailure_t	 IABTNLAddressFailure;
