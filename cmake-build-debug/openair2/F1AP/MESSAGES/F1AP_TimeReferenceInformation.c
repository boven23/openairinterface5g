...
asn_TYPE_member_t asn_MBR_F1AP_TimeReferenceInformation_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct F1AP_TimeReferenceInformation, uncertainty),
	...
	{ ATF_POINTER, 2, offsetof(struct F1AP_TimeReferenceInformation, timeInformationType),
	...
	{ ATF_POINTER, 1, offsetof(struct F1AP_TimeReferenceInformation, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_F1AP_ProtocolExtensionContainer_11023P303,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_F1AP_TimeReferenceInformation_oms_1[] = { 2, 3, 4 };
