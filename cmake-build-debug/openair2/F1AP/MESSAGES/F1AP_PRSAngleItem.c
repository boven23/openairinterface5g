...
asn_TYPE_member_t asn_MBR_F1AP_PRSAngleItem_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct F1AP_PRSAngleItem, nR_PRS_Azimuth_fine),
	...
	{ ATF_POINTER, 3, offsetof(struct F1AP_PRSAngleItem, nR_PRS_Elevation),
	...
	{ ATF_POINTER, 2, offsetof(struct F1AP_PRSAngleItem, nR_PRS_Elevation_fine),
	...
	{ ATF_POINTER, 1, offsetof(struct F1AP_PRSAngleItem, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_F1AP_ProtocolExtensionContainer_11023P198,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_F1AP_PRSAngleItem_oms_1[] = { 1, 2, 3, 4 };
