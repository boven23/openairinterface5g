...
asn_TYPE_member_t asn_MBR_F1AP_SRSCarrier_List_Item_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct F1AP_SRSCarrier_List_Item, pci),
	...
	{ ATF_POINTER, 1, offsetof(struct F1AP_SRSCarrier_List_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_F1AP_ProtocolExtensionContainer_11023P285,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_F1AP_SRSCarrier_List_Item_oms_1[] = { 3, 4 };
